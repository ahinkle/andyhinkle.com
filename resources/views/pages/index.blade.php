<x-app>
    ...
    <div>
        <h2 class="text-gray-900 text-lg font-medium my-5 dark:text-gray-200">
            About
        </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 w-full gap-x-10 gap-y-5 pt-2 px-2">
            <div class="bg-white dark:bg-gray-800 p-1 rounded-lg">
                <svg class="mr-2 size-16 fill-gray-700 dark:fill-gray-300 group-hover:fill-red-400"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168.749 58.695">
                    <g transform="translate(-83.667 -88.949)">
                        ...
                        <path
                            ...
                            transform="translate(-20.025)" "/><rect width="6.429" height="27.937" transform="translate(138.018 88.949)"/><path d="
                            M199.646,88.949h-6.039v13.443h-.078L189.4,88.949h-5.377v27.937h6.04v-13.6h.078l4.169,13.6h5.338Z"
                        ...
                        <path d="M241.143,116.886h6.429V104.73h4.909v-5.26h-4.909v-5.26h6.039v-5.26H241.143Z"
                            transform="translate(-56.721 0)" />
                        <rect width="6.429" height="27.937" transform="translate(198.799 88.949)" />
                        <path d="M290.958,111.626h-5.571v-6.9h4.558v-5.26h-4.558v-5.26H290.8v-5.26H278.958v27.937h12Z"
                            transform="translate(-70.342 0)" />
                        <path d="M313.358,111.626h-5.806V88.949h-6.429v27.937h12.235Z"
                            transform="translate(-78.325 0)" />
                        <path d="M338.653,112.834V93l-4.4-4.053H323.106v27.937h11.377Zm-6.429-1.207h-2.688V94.21h2.688Z"
                        ...
                        <rect width="53.603" height="2.065" transform="translate(198.812 137.266)" />
                        <rect width="53.603" height="2.064" transform="translate(198.812 141.395)" />
                        <rect width="53.603" height="2.064" transform="translate(198.812 145.522)" />
                        <rect width="33.202" height="2.065" transform="translate(219.214 120.753)" />
                        <rect width="33.202" height="2.064" transform="translate(219.214 124.882)" />
                        <rect width="33.202" height="2.064" transform="translate(219.214 129.01)" />
                        <rect width="33.202" height="2.064" transform="translate(219.214 133.138)" />
                        <path
                ...
                <h3 class="text-gray-900 dark:text-gray-200 text-sm font-semibold">
                    <a href="https://apps.apple.com/us/app/springfield-armory/id6447251019" target="_blank"
                        class="hover:underline">
                        Springfield Armory (iOS/Android)
                    </a>
                </h3>
                <p class="text-gray-700 dark:text-gray-300 text-sm pt-2">
                    Mobile app for registering warranties and viewing manuals for Springfield Armory.
                    <span class="block pt-4 text-xs">
                        React Native / Currently rated 4.9/5 on both app stores.
                    </span>
                </p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-1 rounded-lg">
                ...
                <h3 class="text-gray-900 dark:text-gray-200 text-sm font-semibold">
                    <a href="https://www.springfield-armory.com" target="_blank" class="hover:underline">
                ...
                <p class="text-gray-700 dark:text-gray-300 text-sm pt-2">
                    ...
                    <span class="block pt-4 text-xs">
                        WordPress & Laravel / Handles millions of visitors per month.
                    </span>
                </p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-1 rounded-lg">
                <svg class="mr-2 size-16 fill-gray-700 dark:fill-gray-300 group-hover:fill-red-400"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 534 288" xml:space="preserve"
                    class="max-w-[160px]">
                    <path
                        d="M164.1 151.3c-11.4 5.8-22 10.6-31.9 14.9-2.4 21.1-6.3 51.4-11.5 80-.5 2.1-2.6 3.7-4.7 3.2s-3.5-2.6-3.2-4.7c4.9-26.6 8.5-54.3 11-74.9-4.1 10.2-9.1 21.8-14.9 33.6-9.1 18.7-18.2 33.9-27.1 45-5.4 6.7-10.6 12.3-15.8 16.1-6.1 4.5-12 7.2-17.8 7.9-9.5 1.2-17.4-1.3-23.1-7.2-5-5.3-8.1-13.2-9.3-23.7-1.8-14.8 0-34.3 5.6-58.3 4.8-21.1 12.4-44.3 21.8-67.1C52.1 94.2 62 74.2 71.4 59.6c5-7.6 9.7-13.7 13.9-18.2 5.1-5 9.7-7.8 13.8-8.3 6-.7 11.1 1.1 14.8 5.2 6.5 7 9 20.7 7.9 41.9-1.1 17.8-4.5 36.2-6.4 45.7 1.1 1.6.9 4.1-.9 5.4-1.5 1.3-3.6 1.4-5.2.4-3.1-1.9-2.2-5.8-1.9-7.5 1.9-9.1 5.2-27.2 6.2-44.3 1.3-23.3-2.4-32.5-5.7-36.1-2-2.2-4.5-3-7.9-2.6-1.3.2-4.2 1.1-8.9 6-4.1 3.9-8.3 9.5-12.9 16.9-9.1 14-18.8 33.6-27.6 54.9-9.2 22.5-16.5 45.2-21.3 66.1-5.2 22.6-7.2 41.8-5.6 55.4 1.1 8.8 3.5 15.1 7.2 19 3.9 4.1 9.2 5.7 16.3 4.8 8.6-1 18.2-8.1 28.3-20.9 8.3-10.9 17.2-25.4 26.1-43.7 4.4-9.1 8.4-18.1 11.8-26.3l-2.5.9c-12 4.1-22.7 6.7-31.5 7.8l-1.1.1c-6.7.8-12.4.6-16.7-.6-3.5-.9-5.2-2-5.8-2.5-1.7-1.5-1.8-4.1-.3-5.8 1.5-1.7 4-1.8 5.6-.5.4.3 5.1 3 19.1 1.1 8.6-1.2 18.8-4 30.5-8.1l7.1-2.6c5.9-15.1 9.4-25.6 9.6-25.8.5-2 2.5-3.1 4.6-2.6 1.9.3 3.3 2.3 3.2 4.2l-1.8 17.8c8.6-3.7 17.8-8 27.4-13 2-1 4.3-.2 5.3 1.8.7 2.1.1 4.6-2 5.7z" />
                    <path
                        d="M163.7 184.3c-2.2-2.2-3.4-6-3.8-12.6-.2-4.5-.2-10.6.5-17.3.9-11.1 2.8-23.3 4.8-29.4 0-.2-.2-.2-.2-.4-.6-2 .4-4.4 2.4-5.2 2.2-.6 4.6.4 5.4 2.4.1.6.6 1.8.7 2.9-.1.6-.1 1.1-.4 1.7-1.4 4.2-3.6 15.8-4.5 28-.2.2-.1.4-.1.6l.8-2.4c5.4-13.4 13.8-25.4 25.4-35.9 1.7-1.5 4.4-1.5 5.9.2 1.3 1.7 1.3 4.2-.4 5.7-24.7 22.5-27.5 46.4-28.5 55.4l-.4 2.9c-.1 1-.5 3.3-3.1 4.2-.3.2-.5.3-.9.3-1.3.3-2.7-.1-3.6-1.1zM238.8 158.3c-8.3 5-17.5 8.6-25.2 9.5-7.1.9-12.5-1.9-15-7.8-1.9-4.7-2-11.5.2-18.6 2.2-6.7 5.9-12.7 10-16 4.8-3.8 10.3-4.1 14.9-.9 2.7 1.9 4.2 4.8 3.8 8.1-.3 5.5-5 11.6-8.9 15.7-3.5 3.7-7.7 7.2-11.7 9.8 1.4 1.9 3.6 1.8 5.7 1.6 6-.7 15.3-3.9 24-9.7-.3-3.8-.1-8.7 1.4-14.8 2.2-8.6 6.2-16.3 10.9-21 2.5-2.4 5.2-4 8-4.8 3.1-.9 6.4-.6 9.4.9 2.8 1.2 4.4 3.8 4.8 6.8.4 4.7-1.9 10.7-7.3 17.9-4.7 6.3-10.9 12.9-17.9 18.3-.2 0-.2 0-.2.2 0 .4.3.9.5 1.3.8 2 2.8 4.6 8.4 3.9 6.2-.7 14.4-6.5 23.6-16.7 8-8.7 14.5-18.2 17.5-22.8.3-.4.5-.8.6-1 1.3-1.9 3.9-2.4 5.7-1.1 1.9 1.3 2.4 3.9 1.1 5.7-.2.2-.3.6-.7.8-2.9 4.3-9.8 14.6-18.1 23.8-4.7 5.1-9.3 9.5-13.4 12.6-5.6 3.9-10.6 6.2-15.3 6.8-7.6 1-13.7-2.1-16.8-8.5zM219.3 132c.1-.6-.1-.6-.3-.9-.4-.3-1.2-.8-2.4-.7-.7.1-1.6.6-2.7 1.5-2.9 2.3-5.6 6.7-7.3 11.9-.5 1.8-.9 3.5-1.1 5.1 7.3-5.5 13.7-13.1 13.8-16.9zm39.2-3.8c4.6-7 4.6-10.2 4.4-10.6 0 0 0-.2-.2-.2-.4-.1-1.4-.6-2.7-.4-1.3.2-3.1.8-5.1 2.9-3.7 3.7-6.9 10.1-8.7 17.2-.5 2.1-1 4.1-1.1 6.2 5.3-4.8 10-10.1 13.4-15.1z" />
                    <path
                        d="M361 55.3c-15.6 7.4-28.8 12.8-39.5 16.6-2.3 10.3-5.3 20.4-8.6 29.3-3 8.3-6.1 15.5-9.5 21.8.1 14.8 3 37.2 8.5 63.4 1 .3 3.1.9 3.5 3.9.3 2.1-1.1 3.2-2.6 3.9-.5.3-1.4.6-2.4.7h-.4c-.4 0-.9.1-1.3 0-.2 0-.4-.1-.8-.1-.8-.3-2-.9-2.7-2.3-.5-.9-.8-1.8-1.1-3.1l-.1-.9c-2.8-13.5-7.1-36.7-8.3-56-.9.1-1.7-.2-2.5-.6-1.9-1.3-2.4-3.9-1.1-5.7 1.1-1.7 2.2-3.3 3.1-5.3.1-.4.1-1 0-1.3.1-14.6.8-28 1.8-40-8.6 2.2-14.4 3.1-18.3 3.6-1.3.2-2.4.3-3.3.6l-.7.1c-2.1.3-3.8-.1-5.1-1.1-1-.8-1.8-2.1-1.9-3.4-.3-2.2 1.4-4.3 3.6-4.6.9-.1 1.9.3 2.7.8l3.7-.5c4.1-.5 10.4-1.5 20-4 1-9.2 2.1-17.3 3.5-24.3 1.7-9.1 3.9-16.2 6.5-21.3 2.8-6.2 6.6-9.5 10.9-10 2.4-.3 4.6.8 6.1 3.1.7 1.2 3.1 4.9 2.1 19.1-.4 7.3-1.7 15.9-3.4 25 9.6-3.6 21-8.4 34-14.6 2.2-1 4.5-.2 5.5 2 1.1 1.8.1 4.2-1.9 5.2zM312.3 75c-2.4.9-4.7 1.5-6.9 2.2-.6 7.7-1.1 15.9-1.3 24.8.4-1.2.8-2.6 1.4-3.8 2.5-7.1 4.7-15.2 6.8-23.2zm-6.1-6.6c2.6-.7 5.3-1.6 8.2-2.7 0 0 .2-.2.1-.4 2.1-10.5 3.8-20.5 4.1-28.7.5-7.1 0-10.6-.4-12.3-.9.7-2 2.1-3.2 4.8-2.1 4.2-4.2 10.7-5.8 19.1-1.2 5.9-2.1 12.7-3 20.2zM166.3 214.6c6.8 4.5 9.4 14.3 9.4 21.8s-2.7 17.3-9.4 21.8c-2 1.3-4.1 2-6.6 2s-4.7-.8-6.7-2c-6.7-4.5-9.3-14.3-9.3-21.8s2.6-17.3 9.3-21.8c2-1.3 4.2-2 6.7-2 2.4-.1 4.6.7 6.6 2zm-2.7 39.5c5.3-3.5 7.3-11.7 7.3-17.8 0-5.9-2.3-14.1-7.3-17.8-1.1-.7-2.6-1.3-3.9-1.3-1.3 0-2.9.6-4 1.3-5 3.7-7.3 11.8-7.3 17.8 0 6.1 2 14.3 7.3 17.8 1.2.9 2.6 1.3 4 1.3s2.7-.3 3.9-1.3zM207.7 259.6c-.8 0-1.7-.6-2.1-1.4-5.8-11.7-10.1-20.2-16.1-32.3v31.4c0 1.4-1.1 2.4-2.4 2.4-1.4 0-2.4-1.1-2.4-2.4v-41.8c0-1.2 1.1-2.3 2.4-2.3.8 0 1.7.5 2.1 1.3l16.1 32.4v-31.4c0-1.4 1.1-2.4 2.4-2.4 1.4 0 2.4 1.1 2.4 2.4v41.7c0 1.2-1.1 2.4-2.4 2.4zM260 242.8c3 5.5 7.3 13.7 7.3 14.5 0 1.4-1.1 2.4-2.4 2.4-.8 0-1.7-.6-2.1-1.3-3.2-5.9-6.2-11.7-9.3-17.7-1.1.1-2.3.1-3.4.1-.8 0-1.7-.1-2.4-.1h-1.4v16.6c0 1.4-1.1 2.4-2.4 2.4-1.4 0-2.4-1.1-2.4-2.4V216c0-1.4 1.1-2.4 2.4-2.4h9.1c7.5 0 13.6 6 13.6 13.5 0 5.8-2.9 10.6-8.3 12.4l1.7 3.3zm1.8-15.7c0-4.9-4.1-8.7-8.9-8.7h-6.7v17.4h6.7c4.9 0 8.9-3.9 8.9-8.7zM274.9 257.2v-41.5c0-1.2 1.1-2.4 2.4-2.4h19c1.4 0 2.4 1.2 2.4 2.4 0 1.4-1.1 2.4-2.4 2.4h-16.6v14.3h10.4c1.3 0 2.4 1.2 2.4 2.4 0 1.4-1.1 2.4-2.4 2.4h-10.4v17.5h16.6c1.4 0 2.4 1.1 2.4 2.4 0 1.2-1.1 2.4-2.4 2.4h-19c-1.3.1-2.4-1.1-2.4-2.3zM332.5 226.9c0 7.5-6.1 13.5-13.6 13.5h-6.7v16.9c0 1.2-1.1 2.4-2.4 2.4-1.4 0-2.4-1.2-2.4-2.4v-41.7c0-1.3 1.1-2.4 2.4-2.4h9.1c7.5.1 13.6 6.2 13.6 13.7zm-4.8 0c0-4.9-3.9-8.8-8.8-8.8h-6.7v17.5h6.7c4.9 0 8.8-3.8 8.8-8.7zM341.2 257.2v-41.5c0-1.2 1.1-2.4 2.4-2.4h19c1.4 0 2.4 1.2 2.4 2.4 0 1.4-1.1 2.4-2.4 2.4H346v14.3h10.4c1.3 0 2.4 1.2 2.4 2.4 0 1.4-1.1 2.4-2.4 2.4H346v17.5h16.6c1.4 0 2.4 1.1 2.4 2.4 0 1.2-1.1 2.4-2.4 2.4h-19c-1.4.1-2.4-1.1-2.4-2.3zM371.8 257.5c0-.7 12.9-39.9 14-43.1.3-1.1 1.4-1.7 2.3-1.7s2 .5 2.3 1.7c.2 1.1 1.8 5.6 3.7 11.4 4.2 12.6 10.3 31.1 10.3 31.6 0 1.2-1.2 2.4-2.4 2.4-1 0-2-.7-2.3-1.7l-5-15.3h-13.2c-1.7 5.3-3.4 10.1-5 15.3-.4 1.1-1.3 1.7-2.3 1.7-1.4.1-2.4-1.1-2.4-2.3zm11.3-19.5h10l-5-15.4-5 15.4zM432.8 216.2c0 1.4-1.1 2.4-2.4 2.4h-8.5v38.5c0 1.4-1.1 2.4-2.4 2.4-1.4 0-2.4-1.1-2.4-2.4v-38.5h-8.5c-1.4 0-2.4-1.1-2.4-2.4 0-1.4 1.1-2.4 2.4-2.4h21.8c1.2 0 2.4 1.1 2.4 2.4z" />
                    <path
                        d="M446.8 212.7c-4 0-6.1 4.9-3.2 7.8l13.4 13.4c1.1 1.1 1.1 3 0 4.1l-13.4 13.4c-2.9 2.9-.8 7.8 3.2 7.8 1.2 0 2.4-.5 3.2-1.3l18.7-18.7c1.8-1.8 1.8-4.6 0-6.4L450.1 214c-.9-.9-2-1.3-3.3-1.3z" />
                    <path
                        d="M471.3 212.7c-4 0-6.1 4.9-3.2 7.8l13.5 13.5c1.1 1.1 1.1 2.9 0 4l-13.5 13.5c-2.9 2.9-.8 7.8 3.2 7.8 1.2 0 2.4-.5 3.2-1.3l18.7-18.7c1.8-1.8 1.8-4.6 0-6.4L474.5 214c-.8-.9-2-1.3-3.2-1.3z" />
                    <path
                        d="M495.8 212.7c-4 0-6.1 4.9-3.2 7.8l13.5 13.5c1.1 1.1 1.1 2.9 0 4l-13.5 13.5c-2.9 2.9-.8 7.8 3.2 7.8 1.2 0 2.4-.5 3.2-1.3l18.7-18.7c1.8-1.8 1.8-4.6 0-6.4L499 214c-.8-.9-2-1.3-3.2-1.3z" />
                </svg>
                <h3 class="text-gray-900 dark:text-gray-200 text-sm font-semibold">
                    <a href="https://greetonrepeat.com" target="_blank" class="hover:underline">
                        Greet on Repeat
                    </a>
                </h3>
                <p class="text-gray-700 dark:text-gray-300 text-sm pt-2">
                    Greeting Card subscription service for the modern age.
                    <span class="block pt-4 text-xs">
                        TALL Stack / SaaS
                    </span>
                </p>
