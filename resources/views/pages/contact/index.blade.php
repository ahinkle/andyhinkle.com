<x-app>
    <x-slot name="seo">
        <title>Andy Hinkle | Contact</title>
        <meta name="description" content="Contact me for any questions or inquiries.">
    </x-slot>

    <div class="ml-2">
        <h2 class="text-gray-900 text-lg font-medium mt-10 dark:text-gray-200 ml-2">
            Contact
        </h2>
