<x-app>
    ...
    <p class="py-2 text-center font-sans text-sm text-white/75">October 28, 2024</p>
    ...
    <div class="mx-auto mt-8 max-w-3xl">
        ...
        <div class="mt-8 px-4">
            <iframe class="h-96 w-full" src="https://www.youtube.com/embed/aGSA4GLe3a0?si=NXchsI80UDk5CcsS"
