<x-app>
    ...
    <h1 class="text-3xl md:text-5xl font-bold text-white text-center font-sans">Those aren't NBA players, just a bunch of nerdy developers</h1>
