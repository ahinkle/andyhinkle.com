...
<x-app>
    ...
    <article class="py-8 md:py-12">
        ...
        <div class="prose prose-lg prose-invert prose-headings:font-semibold prose-headings:tracking-tight prose-a:text-gray-300 prose-a:underline prose-a:decoration-gray-600 prose-a:underline-offset-2 hover:prose-a:decoration-gray-400 prose-code:text-gray-300 prose-pre:bg-gray-900 prose-pre:p-0 [&_pre]:overflow-x-auto [&_pre]:rounded-lg max-w-none">
            {!! $htmlContent !!}
        </div>

        <footer class="mt-16 border-t border-white/10 pt-8">
            <a
                href="https://github.com/ahinkle/andyhinkle.com/blob/main/resources/content/blog/{{ $post->slug }}.md"
                target="_blank"
