<x-app>
    ...
    <p class="text-white/75 text-center text-sm py-2 font-sans">July 9, 2024</p>
    <h1 class="text-3xl md:text-5xl font-bold text-white text-center font-sans">Useful bash aliases and other shortcuts for Laravel Projects</h1>
    ...
    <div class="max-w-3xl mx-auto mt-8">
        ...
        <p class="text-white/85 text-lg text-left text-balance md:text-wrap mt-2">
...
<p class="text-white/85 text-lg text-left text-balance md:text-wrap mt-2">
    ...
    I believe that he is even the creator of the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">nah</code> alias that is widely used in the community. Here are a few I'm aware of:
</p>
