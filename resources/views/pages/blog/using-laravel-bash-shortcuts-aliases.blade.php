<x-app>
    ...
    <h1 class="text-3xl md:text-5xl font-bold text-white text-center font-sans">Useful bash aliases for Laravel projects
    </h1>
    ...
    <div class="max-w-3xl mx-auto mt-8">
        ...
        <p class="text-white/85 text-lg text-left text-wrap mt-2">
            To create an alias, open your the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">~/.bash_aliases</code>
            or the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">~/.bashrc</code> file and add the
            following line:
        </p>
...
.. or source ~/.bashrc</pre>
        ...
        <p class="text-white/85 text-lg text-left text-wrap mt-2">
            ...
            <code class="bg-gray-900 p-1 rounded-md text-white text-sm">
                ...
                class="bg-gray-900 p-1 rounded-md text-white text-sm">pa migrate</code> to migrate your database.
        </p>
...
alias tf="phpunit --filter"
        ...
        <p class="text-white/85 text-lg text-left text-wrap mt-2">
            ...
            I found the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">cfresh</code> alias to be
            particularly interesting for nuking your vendor directory and <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">composer.lock</code> file.
...
alias glog="git log --graph --pretty=format:'%Cred%h%Creset -%C(yellow)%d%Creset %s %Cgreen(%cr) %C(bold blue)<%an>%Creset' --abbrev-commit"</pre>
        ...
        <p class="text-white/85 text-lg text-left text-wrap mt-2">
            ...
            such as the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">laravel-setup</code> alias.
            Here are a few of my favorites:
        </p>
...
alias sail='[ -f sail ] && sail || vendor/bin/sail'</pre>
        ...
        <p class="text-white/85 text-lg text-left text-wrap mt-2">
            ...
            I found the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">clearlogs</code> alias to be
