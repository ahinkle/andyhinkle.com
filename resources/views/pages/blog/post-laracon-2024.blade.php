<x-app>
    <x-slot name="seo">
        ...
        <meta name="description" content="What an amazing Laracon 2024! Here's a recap of the event, the talks, and the community.">
        <meta property="og:title" content="Laracon 2024, a Recap" />
        <meta property="og:description" content="What an amazing Laracon 2024! Here's a recap of the event, the talks, and the community." />
    ...
    <div class="max-w-3xl mx-auto mt-8">
        ...
        <p class="text-white/85 text-lg text-left">
            Let me take you on a little journey, starting with my arrival in Dallas. This was my fourth Laracon, and I had seen it all—from taking the train in Chicago to navigating the subway in New York. But Dallas? Dallas had a different kind of excitement in store for me.
        </p>
        ...
        <img src="/images/blog/laracon/2024/primeagen.jpg" alt="Andy Hinkle with The Primeagen" class="mt-8 rounded-lg px-4 py-2 mx-auto max-w-[400px]">

        <p class="text-white/85 text-lg text-left mt-4">
            Each talk was packed with value, and every conversation I had left me inspired and recharged. I found myself hopping from one discussion to another, 
            ...
            We didn’t even talk shop—no Livewire, no Alpine.js—just life and kids. It was surreal to discover how much we had in common, and it made me realize that Laracon isn’t just about code; it’s about the connections we make and the friendships we build.
        </p>

        <img src="/images/blog/laracon/2024/caleb-porzio.jpg" alt="Caleb Porzio" class="mt-8 rounded-lg px-4 py-2 mx-auto max-w-[400px]">
