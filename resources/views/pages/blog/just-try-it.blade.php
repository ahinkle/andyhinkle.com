<x-app>
    ...
    <p class="py-2 text-center font-sans text-sm text-white/75">June 26, 2024</p>
    <h1 class="text-center font-sans text-3xl font-bold text-white md:text-5xl">Just Try It</h1>
