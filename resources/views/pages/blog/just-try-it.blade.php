<x-app>
    ...
    <h1 class="text-5xl font-bold text-white text-center font-sans">Just Try It</h1>
    ...
    <div class="max-w-3xl mx-auto mt-8">
        ...
        <h2 class="text-2xl text-white font-bold mt-8 text-left">
            Tailwind CSS
        </h2>
        ...
        <p class="text-white/85 text-lg text-left mt-4 pb-4">
            Cheers
        </p>
</x-app>
