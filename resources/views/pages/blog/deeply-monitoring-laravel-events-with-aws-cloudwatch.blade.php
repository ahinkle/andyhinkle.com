<x-app>
    ...
    <h1 class="text-3xl md:text-5xl font-bold text-white text-center font-sans">Deeply Monitoring Laravel Events with
        AWS CloudWatch</h1>
    ...
    <div class="max-w-3xl mx-auto mt-8">
        ...
        <p class="text-white/85 text-lg text-left mt-4">
            Next, you dive into the database, zeroing in on the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">password_reset_tokens</code> table. Sure enough,
        ...
        <ul class="text-white/85 text-lg text-left mt-4 overflow-hidden">
            <li><code class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Auth\Events\Login</code> - fired
                when a user logs in</li>
            <li><code class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Auth\Events\Logout</code> - fired
                when a user logs out</li>
            <li><code class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Auth\Events\PasswordReset</code>
                - fired when a user resets their password</li>
            <li><code class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Auth\Events\Registered</code> -
                fired when a user registers</li>
            <li><code class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Auth\Events\Attempting</code> -
                fired when a user attempts to log in</li>
            <li><code
                    class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Foundation\Http\Events\RequestHandled</code>
                - fired when a request is handled by the application</li>
            <li><code
                    class="bg-gray-900 p-1 rounded-md text-white text-sm">Illuminate\Database\Events\QueryExecuted</code>
        ...
        <p class="text-white/85 text-lg text-left my-4">
            The easiest way to add these listeners is in your <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">AppServiceProvider.php</code>. Here's an example
            of how you can log the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">Login</code> event:
        </p>
        ...
        <p class="text-white/85 text-lg text-left mt-4">
            In this example, we're listening for the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">Login</code> event and logging the user's ID and
            email address.
        </p>
        ...
        <p class="text-white/85 text-lg text-left mt-4">
            In the example above, I added context to the log message with the second parameter of the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">Log::info</code> method. This context is an array
            of additional data that you want to include in the log message.
        </p>

        <p class="text-white/85 text-lg text-left mt-4">
            The real magic happens when you use the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">Log::withContext</code> method. This method allows
        ...
        <p class="text-white/85 text-lg text-left mt-4">
            In this example, we're sharing context with all log messages within the closure. This means that the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">email</code>, <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">ip</code>, <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">via</code>, and <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">user_agent</code> fields will be added to all log
        ...
        <p class="text-white/85 text-lg text-left mt-4">
            You can add this middleware to the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">web</code>
            middleware group in your <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">bootstrap/app.php</code> file:
        </p>
        ...
        <p class="text-white/85 text-lg text-left mt-4">
            Ensure that you add it to the <code class="bg-gray-900 p-1 rounded-md text-white text-sm">web</code>
