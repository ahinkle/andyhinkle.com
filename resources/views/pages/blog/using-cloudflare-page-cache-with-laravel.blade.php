<x-app>
    ...
    <h1 class="text-3xl md:text-5xl font-bold text-white text-center font-sans">Using Cloudflare Page Cache with Laravel
    </h1>
    ...
    <div class="max-w-3xl mx-auto mt-8">
        ...
        <h2 class="text-2xl md:text-4xl font-bold text-white text-center font-sans mt-8">Step 1: Configure Cloudflare
            Page Rules</h2>
        ...
        <h2 class="text-2xl md:text-4xl font-bold text-white text-center font-sans mt-8">Step 2: Configure Laravel to
        ...
        <p class="text-white/85 text-lg text-left text-wrap mt-4">
            You can test if Cloudflare is caching your pages by checking the <code
                class="bg-gray-900 p-1 rounded-md text-white text-sm">cf-cache-status</code> header in the response
            headers. If it says <code class="bg-gray-900 p-1 rounded-md text-white text-sm">HIT</code> then the page was
