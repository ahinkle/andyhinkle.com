<div class="absolute right-0 top-0 p-4">
    <button class="rounded-full p-2 transition-colors duration-300 hover:bg-gray-200 dark:hover:bg-gray-700"
        x-on:click="darkMode = darkMode === 'dark' ? 'light' : 'dark'" aria-label="Toggle light/dark mode"
        title="Toggle light/dark mode">
        <svg class="hidden size-5 dark:block dark:fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            <path
        ...
        <svg class="block size-5 dark:hidden dark:fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
