<div class="absolute top-0 right-0 p-4">
    <button class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300"
        ...
        <svg class="hidden size-5 dark:fill-gray-400 dark:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            <path
        ...
        <svg class="block size-5 dark:fill-gray-400 dark:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
