                ...
                <div class="col-span-1">
                    <div class="relative flex items-center justify-between">
                        @if ($podcast->video_url)
                            <img src="{{ $podcast->video_thumbnail }}" alt="{{ $podcast->title }}"
                ...
                <div class="col-span-1">
                    <div class="flex h-full flex-col">
                        ...
                        <div class="mt-3 flex-grow">
                            <p class="line-clamp-3 text-sm text-gray-300">{{ str($podcast->summary)->words(20) }}
                            </p>
                        </div>
                        <div class="mt-4 flex-none">
                            <p class="flex items-center justify-between text-xs text-white">
                                <span class="flex items-center">
                                    ...
                                    <time
                                        datetime="{{ $podcast->published_at->format('Y-m-d') }}">{{ $podcast->published_at->format('M j, Y') }}</time>
                                </span>
                                <span class="flex items-center">
