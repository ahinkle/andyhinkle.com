<div x-data="{ activeTab: 'all' }">
    ...
    <!-- Podcasts Only -->
    <div x-show="activeTab === 'podcasts'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    <!-- Speaking Only -->
    <div x-show="activeTab === 'speaking'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
