<aside
    class="fixed bottom-10 right-1 z-50 flex divide-x divide-solid divide-white text-xs shadow-xs hover:opacity-100 motion-safe:transition-opacity"
